...
- (void)initWithViews:(NSArray*)views
{
    for (int i = 0; i < [views count]; i++) {
        ...
        [view setFrame:CGRectMake(0+320*i, 0, 320, [SVGloble shareInstance].globleHeight-44)];
        [self addSubview:view];
    }
    self.contentSize = CGSizeMake(320*[views count], [SVGloble shareInstance].globleHeight-44);
}
